...
const BLOG = {
    AUTHOR: '砂糖桑', // 作者
    BIO: '我的学习笔记。', // 作者简介
    LINK: 'https://notion.fullcomb.top', // 网站地址
    KEYWORDS: 'Notion, 博客, 学习笔记', // 网站关键词 英文逗号隔开
    NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '120acc7cd54a41ecb6cc1851574db6bd', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
    ...
    HOME_BANNER_IMAGE: './bg_image.png', // 首页背景大图，默认文件：/public/bg_image.jpg 。会被Notion中的封面图覆盖。
    SINCE: 2022, // e.g if leave this empty, current year will be used.
    BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '蜀ICP备2022000086号', // 备案号 闽ICP备XXXXXXX
    ...
    CONTACT_EMAIL: '3524336191@qq.com',
    CONTACT_WEIBO: '',
    CONTACT_TWITTER: '',
    CONTACT_GITHUB: 'https://github.com/satoing',
    CONTACT_TELEGRAM: '',
    ...
    TITLE: process.env.NEXT_PUBLIC_TITLE || '学习轨迹', // 站点标题 ，被notion中的页面标题覆盖
    DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '和博客不同，这里主要记录学习笔记', // 站点描述，被notion中的页面描述覆盖
